...
# Configuration
LOG_DIR = "reacher_custom2_final"
VIDEO_DIR = "reacher_custom2videos_final"
...
class ConstraintWrapper(gym.Wrapper):
    def __init__(self, env):
        ...
        print(f"  Training reward = -kinetic_energy - euclidean_distance(target, tip)")
    ...
    def step(self, action):
        ...
        custom_reward, kinetic_energy, euclidean_distance = self.costom_reward(obs)
        ...
        # Use custom reward for training
